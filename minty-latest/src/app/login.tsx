...
export default function LoginScreen() {
  ...
  return (
    <KeyboardAvoidingView style={{ flex: 1, backgroundColor: C.bg }} behavior="padding">
      ...
      >
        {/* Background glow */}
        <View pointerEvents="none" style={{ position: "absolute", top: -80, left: "50%", marginLeft: -200, width: 400, height: 400, borderRadius: 200, backgroundColor: "rgba(255,68,68,0.05)" }} />

        {/* Hero */}
        <View style={{ alignItems: "center", paddingTop: 52, paddingBottom: 32, gap: 12 }}>
          {/* App Logo */}
        ...
        <View style={{ alignItems: "center", gap: 10, marginTop: 24 }}>
          <Pressable onPress={() => completeFlow()} style={({ pressed }) => ({ opacity: pressed ? 0.6 : 1 })}>
