// Auto-embedded from prompt.md. Edit prompt.md and re-run the regenerate command, NOT this file.
// (Inlined because the Supabase CLI does not bundle non-imported assets.)
export const PROMPT_MD = `# Minty Grading Prompt
